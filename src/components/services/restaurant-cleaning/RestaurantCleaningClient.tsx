...
import { RestaurantCleaningInDepthTabs } from "@/components/services/restaurant-cleaning/RestaurantCleaningInDepthTabs";
...
export function RestaurantCleaningClient() {
    ...
    return (
        <main className="bg-white min-h-screen">
                ...
                <div className="relative w-full max-w-7xl mx-auto px-4 md:px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-12 lg:gap-6 items-center flex-1">
                    <div className="space-y-8 mt-12 md:mt-16">
                        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mt-4 md:mt-0">
                            ...
                            <span className="text-white/90 text-sm font-medium tracking-wide uppercase">Restaurant & Kitchen Cleaning</span>
                        </div>
                        <h1 className="text-4xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
                            Professional Restaurant & Kitchen <br />
                            <span className="text-green-300 font-semibold italic">Cleaning</span> You Can Trust
                        </h1>
                        <p className="text-white/80 text-lg lg:text-xl leading-relaxed max-w-lg">Front-of-house polish and back-of-house degrease—compliant kitchen cleans for dining across Victoria.</p>
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            ...
                            <div>
                                ...
                                <span className="text-sm text-green-200">Hospitality-focused</span>
                            </div>
                        </div>
                    </div>
                    <div className="relative mt-8 lg:mt-0">
                        <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/5] max-w-lg mx-auto lg:ml-auto border border-green-800/30">
                            <Image src="/home/PHOTO-2025-10-27-06-41-27.jpg" alt="" className="w-full h-full object-cover" fill priority />
                        </div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.05 PM.jpeg" alt="Restaurant & Kitchen Cleaning cleaning" fill className="object-cover" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold text-[#111827] leading-tight lg:-mr-20">
                                From Pass To <br className="hidden md:block" />
                                <span className="text-[#00b050] italic">Patron</span>
                            {" "}
                            <span className="italic">Table</span>
                            </h2>
                            <p className="text-gray-600 text-lg leading-relaxed">We speak chef and venue manager—grease, glass, and guest-facing detail.</p>
                            <div className="space-y-8 pt-4">
                                <div className="flex gap-5">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Kitchen depth</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Degrease cycles that support EHO visits.</p>
                                    </div>
                                </div>
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[#e5f7ed] flex items-center justify-center border-2 border-[#bce8d0]">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Front polish</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Floors and glass that sell the room.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="pt-6">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">Restaurant cleaning that protects your licence</h2>
                            <p className="text-lg text-muted-foreground leading-relaxed">Exhaust, line, and cool room programs on rotation.</p>
                            <Button className="btn-primary" asChild>
                                <Link href="/contact-us">Request a Quote</Link>
                            </Button>
                            <div className="relative rounded-2xl overflow-hidden shadow-lg mt-6">
                                <img src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.23.30 PM.jpeg" alt="Restaurant & Kitchen Cleaning" className="w-full h-auto max-h-64 object-cover" />
                            </div>
                        </div>
            ...
            <LocationsSection />
            <ServiceOfferingsGrid currentHref="/services/restaurant-cleaning" />
            ...
            <section className="py-24 bg-[#f8fafc] overflow-hidden">
                <div className="container mx-auto px-4 max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.15 PM (1).jpeg" alt="Restaurant & Kitchen Cleaning FAQ" fill className="object-cover" />
                        </motion.div>
                    </div>
                </div>
            </section>
