        ...
        <section className="py-12 md:py-16 bg-[#f8f9fa]">
            <div className="container mx-auto px-4 xl:px-8 max-w-7xl">
                ...
                <div className="max-w-4xl mb-8 md:mb-10">
                    <div className="inline-flex items-center rounded-full border border-gray-200 bg-white px-4 py-1.5 text-sm font-bold text-gray-700 mb-4 shadow-sm">
                        Trusted by homeowners today
                    </div>
                    <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-[#111827] leading-[1.1] mb-4 tracking-tight">
                        Smarter Cleaning. <span className="text-primary font-medium italic">One</span> <br />
                        <span className="text-primary font-medium italic">Simple Service</span> to Refresh
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="relative w-full aspect-[4/3] bg-white rounded-[2rem] p-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                    ...
                    <div className="space-y-6 lg:space-y-7">
                        ...
                        <div className="flex gap-5">
                            <div className="flex-shrink-0 mt-1">
                                <div className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-white border border-gray-100 shadow-sm text-primary">
                                    <CalendarCheck className="h-6 w-6 stroke-[1.5]" />
                                </div>
                            </div>
                            <div>
                                <h3 className="text-lg font-bold text-[#111827] mb-1.5">Smart Booking & Scheduling</h3>
                        ...
                        <div className="flex gap-5">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-[#111827] mb-1.5">Adaptive Cleaning Plans</h3>
                                <p className="text-gray-500 leading-relaxed text-sm md:text-base">
                        ...
                        <div className="flex gap-5">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-[#111827] mb-1.5">Simple & Flexible Service</h3>
                                <p className="text-gray-500 leading-relaxed text-sm md:text-base">
