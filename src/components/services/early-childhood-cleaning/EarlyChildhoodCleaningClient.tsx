...
export function EarlyChildhoodCleaningClient() {
    ...
    return (
        <main className="bg-white min-h-screen">
                    ...
                    <div className="space-y-8 mt-12 md:mt-16">
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            ...
                            <div>
                                ...
                                <span className="text-sm text-green-200">Childcare-approved methods</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.05 PM.jpeg" alt="Early Childhood Cleaning cleaning" fill className="object-cover" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold text-[#111827] leading-tight lg:-mr-20">
                                Safe For Little <br className="hidden md:block" />
                                <span className="text-[#00b050] italic">Explorers</span>
                            </h2>
                            <p className="text-gray-600 text-lg leading-relaxed">We choose products and methods that protect developing immune systems while still knocking down germs.</p>
                            <div className="space-y-8 pt-4">
                                <div className="flex gap-5">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Centre-friendly</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Quiet routines during nap windows where possible.</p>
                                    </div>
                                </div>
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[#e5f7ed] flex items-center justify-center border-2 border-[#bce8d0]">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Regulatory awareness</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Cleaning aligned to licensing expectations.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="pt-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-lg mt-6">
                                <img src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.23.30 PM.jpeg" alt="Early Childhood Cleaning" className="w-full h-auto max-h-64 object-cover" />
                            </div>
                        </div>
            ...
            <EarlyChildhoodCleaningInDepthTabs />
            ...
            <LocationsSection />
            <ServiceOfferingsGrid currentHref="/services/early-childhood-cleaning" />
            ...
            <section className="py-24 bg-[#f8fafc] overflow-hidden">
                <div className="container mx-auto px-4 max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.15 PM (1).jpeg" alt="Early Childhood Cleaning FAQ" fill className="object-cover" />
                        </motion.div>
                    </div>
                </div>
            </section>
