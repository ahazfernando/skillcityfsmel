...
import { IndustrialCleaningInDepthTabs } from "@/components/services/industrial-cleaning/IndustrialCleaningInDepthTabs";
...
export function IndustrialCleaningClient() {
    ...
    return (
        <main className="bg-white min-h-screen">
                ...
                <div className="relative w-full max-w-7xl mx-auto px-4 md:px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-12 lg:gap-6 items-center flex-1">
                    <div className="space-y-8 mt-12 md:mt-16">
                        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mt-4 md:mt-0">
                            ...
                            <span className="text-white/90 text-sm font-medium tracking-wide uppercase">Industrial Cleaning</span>
                        </div>
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            ...
                            <div>
                                ...
                                <span className="text-sm text-green-200">Industrial-grade crews</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.05 PM.jpeg" alt="Industrial Cleaning cleaning" fill className="object-cover" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold text-[#111827] leading-tight lg:-mr-20">
                                Keep Production <br className="hidden md:block" />
                                <span className="text-[#00b050] italic">Lines</span>
                            {" "}
                            <span className="italic">Safer</span>
                            </h2>
                            <p className="text-gray-600 text-lg leading-relaxed">We match crew size and equipment to your shutdown or rolling maintenance windows.</p>
                            <div className="space-y-8 pt-4">
                                <div className="flex gap-5">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Safety culture</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Induction-ready staff and correct PPE for your site rules.</p>
                                    </div>
                                </div>
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[#e5f7ed] flex items-center justify-center border-2 border-[#bce8d0]">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#111827] mb-2">Heavy equipment</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm md:text-base">Ride-on scrubbers and industrial vacuums.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="pt-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-lg mt-6">
                                <img src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.23.30 PM.jpeg" alt="Industrial Cleaning" className="w-full h-auto max-h-64 object-cover" />
                            </div>
                        </div>
            ...
            <LocationsSection />
            <ServiceOfferingsGrid currentHref="/services/industrial-cleaning" />
            ...
            <section className="py-24 bg-[#f8fafc] overflow-hidden">
                <div className="container mx-auto px-4 max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src="/CommercialCleaning/WhatsApp Image 2026-01-14 at 7.26.15 PM (1).jpeg" alt="Industrial Cleaning FAQ" fill className="object-cover" />
                        </motion.div>
                    </div>
                </div>
            </section>
