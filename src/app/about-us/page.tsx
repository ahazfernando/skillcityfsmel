...
export const metadata: Metadata = {
    ...
    twitter: {
        ...
        title: "About Us | Skill City Facility Solutions Melbourne",
        description: "Trusted cleaning in Melbourne, Oakleigh & Victoria since 2009.",
    },
    robots: { index: true, follow: true },
};

const values = [
    { icon: Award, title: "Excellence", description: "We strive for perfection in every clean, ensuring your complete satisfaction." },
    { icon: Users, title: "Teamwork", description: "Our professional team works together seamlessly to deliver outstanding results." },
    { icon: Clock, title: "Reliability", description: "We show up on time, every time, and deliver consistent quality you can count on." },
    { icon: Heart, title: "Care", description: "We treat your home with the same care and respect as we would our own." },
];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            <div className="rounded-3xl overflow-hidden shadow-xl">
                                <img src={cleanHomeImg.src} alt="Clean home interior" className="w-full h-96 object-cover" />
                            </div>
                        </div>
                        <div className="space-y-6">
                            <span className="text-sm font-semibold text-primary uppercase tracking-wider">Our Story</span>
                            <h2 className="text-3xl md:text-4xl font-bold text-foreground">From Small Beginnings to Industry Leaders</h2>
            ...
            <section className="section-padding bg-secondary">
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value) => (
                            <div key={value.title} className="bg-card rounded-3xl p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <section className="section-padding bg-background">
                <div className="container-custom">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-3">Milestones Along the Way</h2>
                    </div>
                    <div className="relative">
